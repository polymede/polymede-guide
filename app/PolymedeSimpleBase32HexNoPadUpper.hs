...
module PolymedeSimpleBase32HexNoPadUpper(polymedeSimple) where

import qualified Data.ByteString.Char8                    as B
import           Data.Multibase.Types


-- | roundtrip a static test string through the multibase codecs, put it to stdout and return it
...
test_input_encoded = encodeBase32HexNoPadUpperToMultibase test_input
